package com.xie.pay.service.impl;
...
import com.xie.pay.utils.HttpUtil;
import com.xie.pay.utils.Pkipair;
...
public class KQServiceImpl implements KQService {
    ...
    public Map<String,String> generateFormData(Integer uid, String phone, BigDecimal rechargeMoney) {
        ...
        String bgUrl = "https://6492j3034w.zicp.fun/pay/kq/get/notify";
        //网关版本，固定值：v2.0,该参数必填。
        String version =  "v2.0";
    ...
    public boolean addRecharge(Integer uid, BigDecimal rechargeMoney, String orderId) {
        ...
        record.setRechargeStatus(YLBConstants.RECHARGE_STATUS_PROCESSING);
    ...
    public void addOrderIdToRedis(String orderId) {
        String key  = RedisConstants.KEY_ORDER_ID_SET;
    ...
    private String generateOrderId(){
        ...
        String key = RedisConstants.KEY_ORDER_ID;
        //使用redis自增来生成唯一id
    ...
    public void handleNotify(HttpServletRequest request){
        ...
        //删除redis中的订单记录
        stringRedisTemplate.boundZSetOps(RedisConstants.KEY_ORDER_ID_SET).remove(orderId);
    }
    ...
    public void handleOrder(HttpServletRequest request) {
        //查询订单号
        Set<String> orders = stringRedisTemplate.boundZSetOps(RedisConstants.KEY_ORDER_ID_SET).range(0, -1);
