      ...
      <div class="user-head">
          ...
          <div class="user-head-right fl">
              ...
              <div class="user-head-money fr">
                  <p>可用余额：<span>￥{{ userInfo.money }}元</span></p>
                  <a href="javascript:void(0)" @click="goLink('/page/user/pay')" class="user-head-a1">充值</a>
      ...
      <div class="user-record-box clearfix">
          ...
          <div class="user-record user-record-2">
              ...
              <table align="center" width="388" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tbody>
                      <tr v-for="recharge,index in rechargeList" :key="recharge.id">
                          <td>{{index+1}}</td>
                          <td>{{ recharge.rechargeStatus }}</td>
              ...
              <!--无记录-->
              <p class="user-record-no">还没有充值记录，请充值：<a href="javascript:void(0)" @click="goLink('/page/user/pay')">充值</a></p>
          </div>
...
export default {
  ...
  mounted () {
    ...
    doGet('/v1/recharge/query').then(res=>{
        if(res && res.data.code == 200){
